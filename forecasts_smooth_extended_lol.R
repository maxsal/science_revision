...
if (arrayid == 1) {
  ...
  message("4-week lockdown start date: April 14, 2021")
  ...
  casename   <- glue("{last_obs + 1}_smooth{span}_4wk")
  ...
  clean_out <- wk4_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "4 week lockdown")   
...
if (arrayid == 2) {
  ...
  casename   <- glue("{last_obs + 1}_smooth{span}_6wk")
  ...
  clean_out <- wk6_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "6 week lockdown")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 3) {
  ...
  message("8 week lockdown start date: April 14, 2021")
  last_obs   <- as.Date("2021-04-14")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
  ...
  casename   <- glue("{last_obs + 1}_smooth{span}_8wk")
  ...
  clean_out <- wk8_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "8 week lockdown")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
