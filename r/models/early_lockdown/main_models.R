...
if (arrayid == 2) {
  ...
  message("Tier II on Tier III start date: March 13, 2021")
  ...
  clean_out <- mar13_t2_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "March 13")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 3) {
  ...
  message("Tier II on Tier IV start date: March 19, 2021")
  ...
  clean_out <- mar19_t2_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "March 19")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 4) {
  ...
  message("Tier II on Tier IV (March 30) start date: March 30, 2021")
  ...
  clean_out <- mar30_t2_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "March 30")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 5) {
  ...
  message("Tier II on Tier IV (April 15) start date: April 15, 2021")
  ...
  clean_out <- apr15_t2_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "April 15")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 6) {
  ...
  message("Tier III on Tier II start date: February 19, 2021")
  last_obs   <- as.Date("2021-02-18")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
  ...
  clean_out <- feb13_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "February 19")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 8) {
  ...
  message("Tier III on Tier IV start date: March 19, 2021")
  last_obs   <- as.Date("2021-03-18")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
...
if (arrayid == 11) {
  ...
  message("Tier IV on Tier II start date: February 19, 2021")
  ...
  clean_out <- feb19_mod %>% cleanr_esir(N = N, adj = T, adj_len = 2, name = "February 19")   
  write_tsv(clean_out$data, file = paste0("./", casename, "_data.txt"))
  write_tsv(clean_out$out_tib, file = paste0("./", casename, "_out_table.txt"))
...
if (arrayid == 16) {
  ...
  message("Tier V on Tier II start date: February 19, 2021")
  last_obs   <- as.Date("2021-02-18")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
