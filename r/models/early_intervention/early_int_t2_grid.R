...
if (arrayid == 1) {
  ...
  message("pre-lockdown start date (early MH + 20%): March 20, 2021")
  last_obs   <- as.Date("2021-03-19")
...
if (arrayid == 2) {
  ...
  message("pre-lockdown start date (early MH + 20%): March 25, 2021")
  last_obs   <- as.Date("2021-03-24")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
  proj_days  <- as.numeric(last_proj - start_proj) - 1
...
if (arrayid == 4) {
  ...
  message("pre-lockdown start date (early MH + 20%): April 5, 2021")
  last_obs   <- as.Date("2021-04-04")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
  proj_days  <- as.numeric(last_proj - start_proj) - 1
...
if (arrayid == 5) {
  ...
  message("pre-lockdown start date (early MH + 20%): April 10, 2021")
  last_obs   <- as.Date("2021-04-09")
  start_obs  <- last_obs - 99
  start_proj <- last_obs + 1
  last_proj  <- last_obs + 200
  proj_days  <- as.numeric(last_proj - start_proj) - 1
...
if (arrayid == 7) {
  ...
  casename   <- glue("{last_obs + 1}_0.95_r{R_0}")
...
if (arrayid == 13) {
  ...
  casename   <- glue("{last_obs + 1}_0.99_r{R_0}")
