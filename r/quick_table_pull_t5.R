...
cases_out <- tibble(
  "March 13" = c(print_cases(mar_13_mar_30), print_cases(mar_13_apr_15), print_cases(mar_13_apr_30), print_cases(mar_13_may_15), print_cases(mar_13_may_30), print_cases(mar_13_jun_15)),
  "March 19" = c(print_cases(mar_19_mar_30), print_cases(mar_19_apr_15), print_cases(mar_19_apr_30), print_cases(mar_19_may_15), print_cases(mar_19_may_30), print_cases(mar_19_jun_15)),
...
write_csv(cases_out, glue("/Volumes/tiny/projects/covid/science_revision/data/early_lockdown/tables/t5_{cfr_type}cfr_{wane_type}_cases.csv"))
...
deaths_out <- tibble(
  "March 13" = c(print_deaths(mar_13_mar_30), print_deaths(mar_13_apr_15), print_deaths(mar_13_apr_30), print_deaths(mar_13_may_15), print_deaths(mar_13_may_30), print_deaths(mar_13_jun_15)),
  "March 19" = c(print_deaths(mar_19_mar_30), print_deaths(mar_19_apr_15), print_deaths(mar_19_apr_30), print_deaths(mar_19_may_15), print_deaths(mar_19_may_30), print_deaths(mar_19_jun_15)),
...
write_csv(deaths_out, glue("/Volumes/tiny/projects/covid/science_revision/data/early_lockdown/tables/t5_{cfr_type}cfr_{wane_type}_deaths.csv"))
