# libraries ----------
ally::libri(data.table, janitor, ggplot2, patchwork, ggpubr)
...
path_to_lockdown_output_files <- "/Volumes/tiny/projects/covid/science_revision/data/"

# data ------------
dat <- fread("data/covid19india_national_counts_20211031.csv")[, date := as.Date(date)]
...
feb_19 <- extracto(
  x     = glue("{path_to_lockdown_output_files}early_intervention/2021-02-19_20pct_t2_r2_forecast_MCMC.RData"),
...
mar_13 <- extracto(
  x     = glue("{path_to_lockdown_output_files}early_lockdown/2021-03-13_t3_r2_forecast_MCMC.RData"),
...
mar_19 <- extracto(
  x     = glue("{path_to_lockdown_output_files}early_lockdown/2021-03-19_t4_r2_forecast_MCMC.RData"),
...
mar_30 <- extracto(
  x     = glue("{path_to_lockdown_output_files}early_lockdown/2021-03-30_t4_r2_forecast_MCMC.RData"),
...
apr_15 <- extracto(
  x     = glue("{path_to_lockdown_output_files}early_lockdown/2021-04-15_t4_r2_forecast_MCMC.RData"),
